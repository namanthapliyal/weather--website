...
const forecast =(lat, lon, callback)=>{
    ...
    request({url, json:true}, (error, {body}={})=>{
        if(error){
            ...
            callback(undefined, "It is currently "+ body.current.temp+ " degrees out ."+ "There is  "+ body.current.humidity +"% humidity. And feels like "+body.current.weather[0].description+'.')
        }
    })
}
